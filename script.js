...
const frmEditOsoba = document.getElementById('frmEditOsoba');
...
function displayTable() {
  ...
  for (let i = 0; i < arrOsoba.length; i++) {
    ...
    <tr>
            ...
            <td>
                <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn  btn-warning edit" onclick="updateOsoba(${i})">Edit</button>
